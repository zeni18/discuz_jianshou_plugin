...
class plugin_jianshou_forum extends plugin_jianshou
{
    ...
    {
        return '<script src="//sns.io/js/min/discuz.js" charset="utf-8" type="text/javascript"></script>';
    }
    ...
    {
        $css = '<link rel="stylesheet" type="text/css" href="//sns.io/lib/layer/skin/layer.css" />';
